...
const CONFIG_DIR = ".open-pencil-ugui";
...
export function ensureGeneratedDir(projectRoot, config) {
  const generatedDir = resolveProjectPath(projectRoot, config.generatedDir ?? ".open-pencil-ugui/generated");
...
export function getSkillFilePath(projectRoot, target, config) {
  ...
  return root ? join(root, "pencil-unity-ugui", "SKILL.md") : "";
}
