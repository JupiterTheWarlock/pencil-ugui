import { loadConfig, resolveProjectPath } from "./config.mjs";
...
export async function runPromptContext(options) {
  ...
  const context = {
    configPath: ".open-pencil-ugui/config.json",
    provider,
    openPencilDir: config.openPencilDir,
    exporterCommand: config.exporterCommand,
    generatedDir: config.generatedDir ?? ".open-pencil-ugui/generated",
    ...
    providerReference: `.cursor/skills/pencil-unity-ugui/references/${provider}/SKILL.md`,
  };
